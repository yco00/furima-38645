...
ActiveRecord::Schema.define(version: 2023_04_15_083113) do
  ...
  create_table "deliveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "buys_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buys_id"], name: "index_deliveries_on_buys_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "firstnameruby", null: false
    t.string "lastnameruby", null: false
  ...
  add_foreign_key "deliveries", "buys", column: "buys_id"
